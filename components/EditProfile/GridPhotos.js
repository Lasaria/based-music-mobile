...
const GridPhotos = ({ userId, photos, setPhotos, onSave, onCancel, onNavigate }) => {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                <TouchableOpacity style={styles.roundButton} onPress={() => onNavigate('MainPreview')}>
                    <Ionicons name="chevron-back" size={20} color={Colors.white} />
                </TouchableOpacity>
                <Text style={styles.headerText}>Edit Profile Photo</Text>
                <Ionicons name="eye" size={24} color={Colors.white} onPress={() => onNavigate('EditPreview')} />
            </View>
